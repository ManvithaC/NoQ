...
import com.example.noq.dummy.DummyContent;
...
public class queueListActivity extends AppCompatActivity {
    ...
    public static class SimpleItemRecyclerViewAdapter
        ...
        private final queueListActivity mParentActivity;
        ...
        private final View.OnClickListener mOnClickListener = new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (mTwoPane) {
                    ...
                    arguments.putString(queueDetailFragment.ARG_ITEM_ID, item.id);
                    ...
                    intent.putExtra(queueDetailFragment.ARG_ITEM_ID, item.id);
        ...
        SimpleItemRecyclerViewAdapter(queueListActivity parent,
